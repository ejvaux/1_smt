                    ...
                    <div class="card">
                        ...
                        <div class="card-body">                        
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="sn" style='height:100%'>
                                    @include('includes.snrl.snumberTab')
                                </div>
                                <div class="tab-pane" id="pn" style='height:100%'>
                                    @include('includes.snrl.pnTab')
                                </div>
                                <div class="tab-pane" id="reel" style='height:100%'>
                                    @include('includes.snrl.reelTab')
                                </div>
                                <div class="tab-pane" id="snpn" style='height:100%'>
