                ...
                <div class="form-group row">
                    {{-- <div class="col-6">
                        <div class="row">
                            ...
                            <div class="col-8">
                                <select id="division_id" class="form-control " name="division_id" placeholder="" required readonly>
                ...
                <div class="form-group row">
                    <div class="col-6">
                        <div class="row">
                            ...
                            <div class="col-8">
                                <select id="process_id" class="form-control" name="process_id" placeholder="">
                                        <option value="">- Please select -</option>
...
<div class="modal hide fade in" role="dialog" id="repair_modal" data-keyboard="false" data-backdrop="static" >
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form id="repair_form" class='form_to_submit' method="post" action=''>
            <div class="modal-body" style="">
                    ...
                    <div class="col-6">
                        <div class="row">
                            ...
                            <div class="col-8">
                                ...
                                <input type="hidden" id='aemployee_id' name="employee_id">
                            </div>
                        </div>
                    </div>                               
                </div>
