...
class MatCompInsert implements ShouldQueue
{
     ...
     * @return void
     */
    public function __construct($req,$mat_load_id)
    {
        $this->req = $req;
        $this->mat_load_id = $mat_load_id;
    }
    ...
    public function handle()
    {
        ...
        if($m){
            ...
            $im->line_id = $line_id;
            $im->mat_load_id = $this->mat_load_id;
            $im->materials = $mt;
            $mt2 = $im->materials;
            $mt2[] = [
